...
public class GattAttributes {
	...
	private static final HashMap<DeviceType, UUID> SERVICE_UUIDS = new HashMap<>();
	private static final HashMap<DeviceType, UUID> CHARACTERISTIC_MEASUREMENT_UUIDS = new HashMap<>();
	...
	static {
		...
		SERVICE_UUIDS.put(DeviceType.BIKE_SPEED, UUID.fromString(SERVICE_CYCLING_SPEED_AND_CADENCE));
		SERVICE_UUIDS.put(DeviceType.BIKE_CADENCE, UUID.fromString(SERVICE_CYCLING_SPEED_AND_CADENCE));
		...
		ATTRIBUTES.put(SERVICE_CYCLING_SPEED_AND_CADENCE, "Cycling Speed & Cadence Service");

		ATTRIBUTES.put(CHARACTERISTIC_HEART_RATE_MEASUREMENT, "Heart Rate Measurement");
		ATTRIBUTES.put(CHARACTERISTIC_CYCLING_SPEED_AND_CADENCE_MEASUREMENT, "Cycling Speed Measurement");
		ATTRIBUTES.put(CHARACTERISTIC_MANUFACTURER_NAME, "Manufacturer Name String");
	}
